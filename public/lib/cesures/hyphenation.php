...
// GET DATA
			// Set defaults
			if(!isset($GLOBALS["language"])) $GLOBALS["language"] = "fr";
			if(!isset($GLOBALS["path_to_patterns"])) $GLOBALS["path_to_patterns"] = "lib/cesures/patterns/";
			if(!isset($GLOBALS["dictionary"])) $GLOBALS["dictionary"] = "lib/cesures/dictionary.txt";
